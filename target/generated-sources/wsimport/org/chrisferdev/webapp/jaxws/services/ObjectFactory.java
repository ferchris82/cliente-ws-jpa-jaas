 ...
 * generated in the org.chrisferdev.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private static final QName _Guardar_QNAME = new QName("http://services.jaxws.webapp.chrisferdev.org/", "guardar");
    private static final QName _GuardarResponse_QNAME = new QName("http://services.jaxws.webapp.chrisferdev.org/", "guardarResponse");
    private static final QName _Listar_QNAME = new QName("http://services.jaxws.webapp.chrisferdev.org/", "listar");
    private static final QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.chrisferdev.org/", "listarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.chrisferdev.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.chrisferdev.org/", name = "guardar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.chrisferdev.org/", name = "guardarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.chrisferdev.org/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.chrisferdev.org/", name = "listarResponse")
